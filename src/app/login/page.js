  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('userTokenTimestamp', new Date().getTime().toString())
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm transition duration-200"
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              User access • All rights reserved
            </p>
          </div>
        </div>
      </div>
